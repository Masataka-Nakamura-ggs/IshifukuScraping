...
# -*- coding: utf-8 -*-
"""
AWS Lambda + Selenium Layer対応版: 石福金属興業金価格スクレイピング (LEGACY)

注意: このファイルはレガシーです。現在の推奨Lambdaエントリーポイントは
`src/main_lambda.py` の `lambda_handler` です。新規デプロイや更新ではこちらを使用してください。
